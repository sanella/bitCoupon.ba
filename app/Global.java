...
//		Coupon.createCoupon("Vikend u Neumu", 80, "11.03.2015", "http://static.panoramio.com/photos/large/26139268.jpg", 
//				"Putovanja", "Vikend za dvoje u Neumu", "Vikend za dvoje u Neumu");
//		}
//		if (Coupon.checkByName("Teretana 2u1") == false){
//		Coupon.createCoupon("Teretana 2u1", 40,  "06.05.2015", "http://www.fitingym.com/images/gym_instructor_courses_qualifications_container.jpg", 
//				"Sport", "Jedan mjesec gratis treniranja", "Najnovije sprave");
//		}
//		if (Coupon.checkByName("Vecera za dvoje") == false){
//		Coupon.createCoupon("Vecera za dvoje", 70,  "16.03.2015", "http://www.ramadasuitesorlandoairport.com/images/dinner.jpg", 
